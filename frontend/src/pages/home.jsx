        ...
        <section className="px-8 py-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {products.slice(0, 4).map((item) => (
              <div
                key={item.id}
                className="group bg-white dark:bg-gray-900 rounded-2xl shadow hover:shadow-2xl p-2 transition-all duration-300 transform hover:-translate-y-2 flex flex-col justify-between"
              >
                ...
                <div className="p-5 flex flex-col items-center text-center">
                  ...
                  <button
                    ...
                    } px-6 py-2 rounded-full font-semibold hover:scale-105 transition cursor-pointer`}
                  >
